            ...
            {cartData.map((program)=>(
                ...
                <div className='cart1'>
                  ...
                  <div className='name_price_cart'>
                    ...
                    <div className='Cookie_cart price_cart'>{"Rs. "+program.selling}</div>
                    </div>
                    <div className="cart_selling_detail">
                    <div className='Cookie_cart for_cart'> Quantity</div>
                    <div className='Cookie_cart price_cart'>{program.quntity}</div>
                    </div>
                    <div className="cart_selling_detail">
                    <div className='Cookie_cart for_cart'> Tatal</div>
                    <div className='Cookie_cart price_cart'>{"Rs. "+program.quntity * program.selling}</div>
                    </div>
                    </div>
                  </div>
                </div>
